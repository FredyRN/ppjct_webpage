...
function setLanguage(lang) {
  ...
  // Update WhatsApp link text depending on language
  const waBtnHero = document.getElementById('wa-btn-hero');
  const waBtnContact = document.getElementById('wa-btn-contact');
