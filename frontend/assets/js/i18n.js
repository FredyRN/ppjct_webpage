 ...
 *    Supported pages: index | about | automation | backend | notFound
  ...
  var translations = {
    ...
    es: {
      ...
      automation: {
        ...
        autoHeroDesc: "Elimina procesos manuales, conecta tus sistemas desconectados y reduce el tiempo operativo de tu equipo en un <strong>70% o más</strong>.",
        ...
        autoPainEyebrow: "Problemas comunes",
        autoPainTitle: "¿Tu equipo <span class=\"grad\">pierde tiempo</span> en esto?",
        autoPain1Title: "💬 Tareas repetitivas en mensajería",
        autoPain1Desc: "Responder las mismas preguntas por WhatsApp una y otra vez, perdiendo clientes por demoras en respuesta.",
        autoPain2Title: "📊 Datos fragmentados e islas de información",
        autoPain2Desc: "Copiar datos manualmente entre hojas de cálculo, CRMs y sistemas que no se hablan entre sí.",
        autoPain3Title: "📄 Cotizaciones y facturas manuales",
        autoPain3Desc: "Generar cotizaciones y facturas a mano, expuesto a errores de digitación y demoras de horas o días.",
        ...
        autoStep1Title: "1. 📞 Llamada de diagnóstico",
        autoStep1Desc: "15 minutos para entender la operación actual, identificar cuellos de botella y priorizar las automatizaciones de mayor impacto.",
        autoStep2Title: "2. 📋 Propuesta técnica",
        autoStep2Desc: "Diseño de arquitectura, selección de herramientas, tiempo estimado de entrega y presupuesto a precio cerrado sin sorpresas.",
        autoStep3Title: "3. ⚙️ Implementación",
        autoStep3Desc: "Desarrollo iterativo de los flujos y bots, con pruebas continuas y demos semanales para validar cada avance.",
        autoStep4Title: "4. 🚀 Entrega + Soporte",
        autoStep4Desc: "Puesta en producción, documentación detallada de uso, capacitación a tu equipo y soporte post-lanzamiento.",
        autoStackEyebrow: "Tecnologías",
        autoStackTitle: "Stack de <span class=\"grad\">automatización</span>",
        autoCtaTitle: "¿Listo para <span class=\"grad\">automatizar tu operación</span>?",
        autoCtaDesc: "Agenda una llamada corta de 15 minutos para revisar tus cuellos de botella y diseñarte una solución a medida.",
      ...
      backend: {
        ...
        beHeroDesc: "APIs robustas, microservicios escalables y despliegues Docker listos para producción. Go, Python, PostgreSQL.",
        ...
        beChip4: "Docker",
        beChip5: "CI/CD",
        bePainEyebrow: "Problemas comunes",
        bePainTitle: "¿Tu backend <span class=\"grad\">te frena</span>?",
        bePain1Title: "🐌 APIs lentas que no escalan",
        bePain1Desc: "Cuellos de botella en la base de datos, consultas N+1 no optimizadas y servidores que colapsan ante picos de tráfico.",
        bePain2Title: "🔥 Deploys manuales con downtime",
        bePain2Desc: "Despliegues manuales sin pipelines de CI/CD, propensos a errores humanos y con caídas de servicio en cada actualización.",
        bePain3Title: "🧱 Código legacy difícil de mantener",
        bePain3Desc: "Sistemas monolíticos sin pruebas automatizadas, sin documentación y con deuda técnica que paraliza nuevas funcionalidades.",
        beSolEyebrow: "Servicios Backend",
        beSolTitle: "Lo que <span class=\"grad\">construyo</span>",
        beSol1Title: "⚙️ APIs REST & Microservicios (Go / Python)",
        beSol1Desc: "Endpoints de alta velocidad con arquitectura limpia, autenticación JWT/OAuth2, rate limiting, validación estricta y suite completa de pruebas unitarias y de integración.",
        beSol1Cta: "Agendar consultoría →",
        beSol2Title: "🤖 Web Scraping & Extracción de Datos",
        beSol2Desc: "Bots resilientes con rotación de proxies, bypassing de anti-bots, extracción automatizada y pipelines ETL estructurados en tiempo real.",
        beSol2Cta: "Agendar consultoría →",
        beSol3Title: "🐳 Dockerización & Despliegue VPS",
        beSol3Desc: "Multi-stage builds de Docker, proxies inversos (Traefik/Nginx), SSL automático, CI/CD con GitHub Actions y métricas de observabilidad.",
        beSol3Cta: "Agendar consultoría →",
        beProcessEyebrow: "Proceso",
        beProcessTitle: "Proceso de <span class=\"grad\">trabajo</span>",
        beStep1Title: "1. 📞 Llamada de diagnóstico",
        beStep1Desc: "15 minutos para entender tu arquitectura actual, requerimientos técnicos y objetivos del proyecto.",
        beStep2Title: "2. 📋 Diseño técnico",
        beStep2Desc: "Diagramas de arquitectura, selección del stack ideal, contratos de API (OpenAPI/Swagger) y estimación detallada de esfuerzo.",
        beStep3Title: "3. ⚙️ Desarrollo iterativo",
        beStep3Desc: "Sprints cortos con entregas continuas, código limpio, pruebas automatizadas y comunicación constante.",
        beStep4Title: "4. 🚀 Deploy + Monitoreo",
        beStep4Desc: "Despliegue containerizado sin tiempo de inactividad, configuración de CI/CD y métricas de observabilidad en tiempo real.",
        beStackEyebrow: "Stack Backend",
        beStackTitle: "Tecnologías <span class=\"grad\">especializadas</span>",
        beCtaTitle: "¿Necesitas un backend que <span class=\"grad\">escale</span>?",
        beCtaDesc: "Agenda una consultoría gratuita de 15 minutos para revisar tu arquitectura actual y diseñar la mejor solución.",
        beCtaCal: "📅 Agendar Consultoría Gratuita",
        beCtaWa: "💬 WhatsApp",
        beCtaEmail: "✉️ Email"
      },
    ...
    en: {
      ...
      automation: {
        ...
        autoHeroDesc: "Eliminate manual processes, connect disconnected systems, and reduce your team's operational time by <strong>70% or more</strong>.",
        ...
        autoChip3: "AI Agents",
        autoChip4: "MCP Servers",
        autoPainEyebrow: "Common Problems",
        autoPainTitle: "Is your team <span class=\"grad\">wasting time</span> on this?",
        autoPain1Title: "💬 Repetitive messaging tasks",
        autoPain1Desc: "Answering the exact same questions on WhatsApp over and over, losing potential clients due to delayed responses.",
        autoPain2Title: "📊 Fragmented data & information silos",
        autoPain2Desc: "Manually copying data between spreadsheets, CRMs, and software systems that don't talk to each other.",
        autoPain3Title: "📄 Manual quotes & invoicing",
        autoPain3Desc: "Creating quotes and invoices by hand, prone to typing errors and delays of hours or days.",
        autoSolEyebrow: "Solutions",
        autoSolTitle: "How I <span class=\"grad\">solve it</span>",
        autoSol1Title: "WhatsApp Bot → Quoting → Invoicing",
        autoSol1Impact: "<strong>Impact:</strong> Reduces customer response time from 15 minutes to 3 seconds. Instantly replies with catalog & VAT pricing and auto-generates PDF invoices.",
        ...
        autoSol2Cta: "→ Automate your process",
        ...
        autoSol3Cta: "→ Build your agent",
        autoProcessEyebrow: "Process",
        autoProcessTitle: "Work <span class=\"grad\">process</span>",
        autoStep1Title: "1. 📞 Discovery call",
        autoStep1Desc: "15 minutes to understand current operations, identify bottlenecks, and prioritize high-impact automations.",
        autoStep2Title: "2. 📋 Technical proposal",
        autoStep2Desc: "Architecture design, tool selection, estimated delivery time, and fixed-price quote with no surprises.",
        autoStep3Title: "3. ⚙️ Implementation",
        autoStep3Desc: "Iterative development of workflows and bots, with continuous testing and weekly demos to validate progress.",
        autoStep4Title: "4. 🚀 Delivery + Support",
        autoStep4Desc: "Production deployment, detailed documentation, team training, and post-launch support.",
        autoStackEyebrow: "Technologies",
        autoStackTitle: "Automation <span class=\"grad\">stack</span>",
        autoCtaTitle: "Ready to <span class=\"grad\">automate your operation</span>?",
        autoCtaDesc: "Book a brief 15-minute call to review your bottlenecks and design a tailored solution.",
      ...
      backend: {
        ...
        beHeroDesc: "Robust APIs, scalable microservices and production-ready Docker deployments. Go, Python, PostgreSQL.",
        ...
        beChip4: "Docker",
        beChip5: "CI/CD",
        bePainEyebrow: "Common Problems",
        bePainTitle: "Is your backend <span class=\"grad\">holding you back</span>?",
        bePain1Title: "🐌 Slow APIs that don't scale",
        bePain1Desc: "Database bottlenecks, unoptimized N+1 queries, and servers that crash under traffic spikes.",
        bePain2Title: "🔥 Manual deploys with downtime",
        bePain2Desc: "Manual deployments without CI/CD pipelines, prone to human error and service downtime on every release.",
        bePain3Title: "🧱 Legacy code hard to maintain",
        bePain3Desc: "Monolithic systems with no automated tests, no documentation, and technical debt freezing new features.",
        beSolEyebrow: "Backend Services",
        beSolTitle: "What I <span class=\"grad\">build</span>",
        beSol1Title: "⚙️ REST APIs & Microservices (Go / Python)",
        beSol1Desc: "High-speed endpoints with clean architecture, JWT/OAuth2 auth, rate limiting, strict validation, and comprehensive unit/integration test suites.",
        beSol1Cta: "Book consultation →",
        beSol2Title: "🤖 Web Scraping & Data Extraction",
        beSol2Desc: "Resilient bots with proxy rotation, anti-bot bypassing, automated extraction, and real-time structured ETL pipelines.",
        beSol2Cta: "Book consultation →",
        beSol3Title: "🐳 Dockerization & VPS Deployment",
        beSol3Desc: "Multi-stage Docker builds, reverse proxies (Traefik/Nginx), auto SSL, CI/CD with GitHub Actions, and observability metrics.",
        beSol3Cta: "Book consultation →",
        beProcessEyebrow: "Process",
        beProcessTitle: "Work <span class=\"grad\">process</span>",
        beStep1Title: "1. 📞 Discovery call",
        beStep1Desc: "15 minutes to understand your current architecture, technical requirements, and project goals.",
        beStep2Title: "2. 📋 Technical design",
        beStep2Desc: "Architecture diagrams, ideal stack selection, API contracts (OpenAPI/Swagger), and detailed effort estimation.",
        beStep3Title: "3. ⚙️ Iterative development",
        beStep3Desc: "Short sprints with continuous deliverables, clean code, automated testing, and constant communication.",
        beStep4Title: "4. 🚀 Deploy + Monitoring",
        beStep4Desc: "Zero-downtime containerized deployment, CI/CD setup, and real-time observability metrics.",
        beStackEyebrow: "Backend Stack",
        beStackTitle: "Specialized <span class=\"grad\">technologies</span>",
        beCtaTitle: "Need a backend that <span class=\"grad\">scales</span>?",
        beCtaDesc: "Book a free 15-minute consultation to review your current architecture and design the best solution.",
        beCtaCal: "📅 Book Free Consultation",
        beCtaWa: "💬 WhatsApp",
        beCtaEmail: "✉️ Email"
      },
      ...
      notFound: {
        ...
        text: "The link may be broken or the page may have moved. Return home to check out my projects and automation services.",
